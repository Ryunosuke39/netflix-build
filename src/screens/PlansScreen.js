    ...
    const loadCheckout = async (priceId) => {
        ...
        docRef.onSnapshot(async(snap) => {
            ...
            if (sessionId) {
                ...
                const stripe = await loadStripe('pk_test_51PQkbrEbCqqieyBC1u2cxnwwzEEHW8TE6jPKeADIJoE40TGrzg3KAjhn9pl0yFHymt60Yyx26wxwvj3xorSK4NaY00JJEdQdo6');
            ...
            {Object.entries(products).map(([productId, productData]) => {
                ...
                return (
                    ...
                    >
                        ...
                        >
                            {isCurrentPackage ? 'Current Package' : 'Subscrbe'}
                        </button>
                    </div>
                )
            })}
